...
def parse_args():
    ...
    parser.add_argument("--save_bit_dir", type=str, default=None, help="Where to store the bit tensor.")
    parser.add_argument("--load_bit_dir", type=str, default=None, help="Where to load the bit tensor.")
...
def main():
    ...
    if args.alam:
        save_bit_path=None
        load_bit_path=None
        if args.save_bit_dir != None:
            current_dir = os.path.dirname(os.path.abspath(__file__))
            save_bit_path = os.path.join(current_dir, args.save_bit_dir, "bit_tensor.pt")
        if args.load_bit_dir != None:
            current_dir = os.path.dirname(os.path.abspath(__file__))
            load_bit_path = os.path.join(current_dir, args.load_bit_dir, "bit_tensor.pt")
